...
from pip._internal.utils.rdcndmet import rdCndGetNames, rdCndIsNameIn
...
class ListCommand(IndexGroupCommand):
    ...
    def __init__(self, *args, **kw):
        ...
        cmd_opts.add_option(
            ...
            dest='list_format',
            default="columns",
            choices=('columns', 'columnsx', 'freeze', 'json'),
            help="Select the output format among: columns (default), columnsx, freeze, "
                 "or json",
        )
    ...
    def output_package_listing(self, packages, options):
        ...
        if (options.list_format == 'columns' or options.list_format == 'columnsx') and packages:
